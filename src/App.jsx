    ...
    <ThemeProvider theme={theme}>
      ...
      <Box
        sx={{
          height: "100dvh",
          width: "100%",
          bgcolor: "#05020A", // สีม่วงเข้มเกือบดำ
          color: "#fff",
          display: "flex",
      ...
      >
        <Box
          sx={{
            ...
            height: "100vh",
            backgroundImage:
              "radial-gradient(circle at 50% 30%, #1A0B2E 0%, #05020A 70%)", // ม่วงสว่างไล่ไปดำ
            zIndex: 0,
            pointerEvents: "none",
          }}
        >
          {[...Array(35)].map((_, i) => {
            const isPink = i % 2 === 0;
            const color = isPink ? "#FFB7C5" : "#E6E6FA"; // ดาวสีชมพูอ่อนสลับลาเวนเดอร์
        ...
        >
          <motion.div
            ...
            style={{
              ...
              height: "300px",
              background:
                "radial-gradient(circle, rgba(255, 105, 180, 0.15) 0%, transparent 70%)", // แสงหลังชื่อสีชมพู
              filter: "blur(40px)",
              zIndex: 0,
              pointerEvents: "none",
            }}
