...
const sparklerItemstest = [
  {
    ...
    quote: "",
    image: `${baseUrl}images/CB/Shoji.png`,
    rate: 10, // Adjusted
  },
  {
    id: 4,
...
const sparklerFinal = [
  ...
  },
  {
    ...
    quote: "",
    image: `${baseUrl}images/CB/Tsuru.png`,
    rate: 5.45,
  },
  {
    id: 6,
  ...
  },
  {
    ...
    desc: `เมื่อปลายสุดของแท่งไม้ถูกจุด กลับพบดอกไม้บานออกมา บุปผาแก้วสีสวยอันบอบบาง คุณทำได้เพียงมองมันเบ่งบาน ก่อนจะค่อยร่วงโรยลงอย่างช้า ๆ ทีละกลีบ ทีละกลีบ...\n\nกลิ่นไม้หอมคละคลุ้งอยู่ทั่ว ชวนผ่อนคลายหลับตาฝันถึงเรื่องราวที่ผ่านมา หรืออนาคตที่ไม่อาจจินตนาการได้\n\nยามกลีบสุดท้ายร่วงหล่น กลิ่นหอมนั้นก็จางหายไป เหลือไว้เพียงเศษกิ่งไม้ธรรมดา ๆ อันนึง\n\nช่างเป็นช่วงเวลาที่แสนสั้น...`,
    quote: "",
    image: `${baseUrl}images/CB/Jun.png`,
    rate: 5.45,
  },
  {
    id: 8,
  ...
  },
  {
    ...
    quote: "",
    image: `${baseUrl}images/CB/Yoru.png`,
    rate: 5.45,
  },
  {
    id: 10,
  ...
  },
  {
    ...
    quote: "",
    image: `${baseUrl}images/CB/Madoka.png`,
    rate: 5.45,
  },
  {
    id: 12,
  ...
  },
  {
    ...
    desc: `แท่งไฟเย็นธรรมดาที่จะมีเศษผลึกสีน้ำเงินประกอบอยู่ภายในประปราย\nและเมื่อทำการเริ่มจุดไฟ ประกายแสงสีฟ้าใสจะส่องสว่างออกมาราวกับช่วงเวลาของท้องฟ้า\n\nแสงสว่างนั้นทอประกายเรื่อย ๆ จนใกล่ถึงส่วนปลายของแท่งไฟ แม้ว่าจะเพียงเวลาสั้น ๆ \nแต่สนใจลองมองท้องฟ้าไปพร้อมกับแท่งไฟเย็นหรือเปล่าละ ?`,
    quote: "",
    image: `${baseUrl}images/CB/Shinso.png`,
    rate: 5.45,
  },
  {
    id: 14,
